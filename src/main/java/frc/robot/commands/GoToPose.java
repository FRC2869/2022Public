...
import static frc.robot.Constants.autoturnspeed;
...
public class GoToPose extends CommandBase {
	...
	public void execute() {
		if (!rotated){
			DrivetrainSubSys.drv(0, clamp((tarpos.getRotation().getDegrees() - drive.getGyroHeading())/20, autoturnspeed, autoturnspeed));
