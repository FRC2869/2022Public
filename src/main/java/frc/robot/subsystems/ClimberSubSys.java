...
import static frc.robot.Inputs.climbDown;
import static frc.robot.Inputs.climbUp;
import static frc.robot.Inputs.getManualClimb;
...
public class ClimberSubSys extends SubsystemBase {
	...
	void set(double speed) {
		...
		System.out.println("1"+((rightswitch.get()) +" " + (speed < 0)));
		System.out.println("2"+((getPos(right) < uplim)+ " "+ (speed > 0)));
	...
	public ClimberSubSys() {
		//TODO: Check if this limit is enough, also make sure limit is less than the breaker on pdp
	...
	public void periodic() {
		...
		//turn off motor if the limit switch is pressed
		if(!leftswitch.get()){
